    ...
    <div className="w-full min-h-screen flex flex-col items-center justify-center pt-24 bg-gray-50">
      {currentQuestionIndex < data.length && (
        ...
        >
          ...
          <div className="font-semibold text-white w-24 p-2 rounded-md text-center -mt-4 absolute right-4 md:right-10 top-0 bg-violet-600 border-b-2 border-violet-900 shadow-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {data[currentQuestionIndex].incorrect_answers.map(
              (answer, index) => (
                <div
                  key={index}
                  className="rounded-xl text-white font-semibold p-3 md:p-5 bg-violet-600 hover:bg-violet-500 border-b-4 border-violet-900 cursor-pointer"
